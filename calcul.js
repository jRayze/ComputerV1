    function selectReponse(degreMax, tabPui, a, b, c) {
        if (degreMax > 2) {
            ...
            console.log(reponse);
            console.log("L'equation est de degre "+degreMax+" ComputerV1 ne peux resoudre cette equation !");
            reponse = reponse + "<br>L'equation est de degre "+degreMax+" ComputerV1 ne peux resoudre cette equation !"
